 ...
 */
#define NUC126_PWM_CH0_PIN_NONE                 0x0
#define NUC126_PWM_CH0_PIN_PA12                 0x1
#if defined(NUC126xxxxx)
#define NUC126_PWM_CH0_PIN_PC8                  0x2
#endif
 ...
 */
#define NUC126_PWM_CH1_PIN_NONE                 0x0
#define NUC126_PWM_CH1_PIN_PA13                 0x1
#if defined(NUC126xxxxx)
#define NUC126_PWM_CH1_PIN_PB9                  0x2
#endif

/**
 * @brief   Channel 2 output pin mask values.
 */
#define NUC126_PWM_CH2_PIN_NONE                 0x0
#define NUC126_PWM_CH2_PIN_PA14                 0x1
#define NUC126_PWM_CH2_PIN_PC12                 0x2

/**
 * @brief   Channel 3 output pin mask values.
 */
#define NUC126_PWM_CH3_PIN_NONE                 0x0
#define NUC126_PWM_CH3_PIN_PA15                 0x1
#define NUC126_PWM_CH3_PIN_PC13                 0x2
/** @} */
 ...
 */
#if !defined(NUC126_PWM_USE_PWM1) || defined(__DOXYGEN__)
#define NUC126_PWM_USE_PWM1 TRUE
#endif

/**
 * @brief   PWMD1 driver IRQ priority.
 */
#if !defined(NUC126_PWM_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define NUC126_PWM_IRQ_PRIORITY 3
#endif
/** @} */
